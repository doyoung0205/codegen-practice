...
@Api(value = "RecruitGet", description = "the RecruitGet API")
public interface RecruitGetApi {

    Logger log = LoggerFactory.getLogger(RecruitGetApi.class);
    ...
    @ApiOperation(value = "특정 모집의 정보를 조회합니다.", nickname = "getRecruitById", notes = "", response = RecruitModel.class, tags={ "recruitGet", })
    @ApiResponses(value = { 
    ...
    default ResponseEntity<RecruitModel> getRecruitById(@ApiParam(value = "특정 모집을 식별하기 위한 Property",required=true) @PathVariable("recruitId") String recruitId) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            ...
            log.warn("ObjectMapper or HttpServletRequest not configured in default RecruitGetApi interface so no example is generated");
        }
